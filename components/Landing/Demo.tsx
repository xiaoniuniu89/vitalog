...
<div className="flex flex-col items-center">
      <div className="text-center">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-gray-500 lg:mx-auto">
          Click the button on the bottom right to open analysis
        </p>
      </div>
